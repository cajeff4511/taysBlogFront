...
const About = () => {
  return (
    <motion.div 
      ...
      className="h-auto sm:h-[100vh] w-full bg-[#8ea5b0] flex flex-col sm:flex-row justify-center items-center p-4"
    >
      <motion.div 
      ...
      >
        <div className="max-w-[360px] w-full mb-5">
        ...
        <div>
          <p className="text-white max-w-[350px] w-full text-sm sm:text-lg text-center">
